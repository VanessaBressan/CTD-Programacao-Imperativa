...
//[0.66666666666667, 0.133333333333, 0.2, 0.2666666666666, 0.33333333333]
...
console.log(filtroDeArrays(arrayPalavras, 4)); 
//[ 'leandro', 'nicolas', 'esteban', 'pedro' ]
  

// 3.Crie um array de objetos literais, onde cada objeto será um aluno e terá dois atributos: nome e nota.
//Crie duas funções que ordenam o array: uma ordenará os alunos em ordem alfabética e a outra o fará por
//nota, da mais alta para a mais baixa. (Analise qual método seria apropriado para este caso. 
//Recomendamos que você consulte a documentação do MDN: https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/Array)
...
// Temos que fazer um sistema para um Agricultor controlar suas vendas. Ele tem um controle de vendas 
//em um caderno, onde os produtos estão organizados por nome, preço e quantidade vendida. 
// Portanto, crie um array de objetos literais com essas informações. No sistema, você tem que adicionar
//uma função (ou várias) que realize os seguintes passos:
...
// 5.Encontre um produto e atribua a ele um novo valor (reutilize o código que 
//permite encontrar o produto pelo nome).
